...
*/
CDIO_EXTERN driver_return_code_t read_audio_sectors_win32ioctl (_img_private_t *p_obj,
 ...
 */
CDIO_EXTERN uint8_t *read_cdtext_win32ioctl (void *p_user_data);

/*!
  Read CD-Text and return cdtext_t structure.
 */
CDIO_EXTERN cdtext_t *get_cdtext_win32ioctl (void *p_user_data);
